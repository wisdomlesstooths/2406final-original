...
const Review = require("./ReviewModel"); //used to be purchase, so maybe MovieModel
...
router.param("id", function(req, res, next, value){
	...
	Review.findById(oid).populate("reviewer movie") //buyer and product are the 2 properties we want data for
...
//make UserModel link at top? and one of these for movies?
